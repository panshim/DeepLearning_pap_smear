...
def main(args):
    ...
    if img_size == 32:
        ...
        valid_x = pickle.load( open( "/content/drive/My Drive/pap_smear/valid_x32.p", "rb" ) )
        test_x = pickle.load( open( "/content/drive/My Drive/pap_smear/test_x32.p", "rb" ) )
    if img_size == 48:
        train_x = pickle.load( open( "/content/drive/My Drive/pap_smear/train_x48.p", "rb" ) )
        valid_x = pickle.load( open( "/content/drive/My Drive/pap_smear/valid_x48.p", "rb" ) )
        test_x = pickle.load( open( "/content/drive/My Drive/pap_smear/test_x48.p", "rb" ) )

    train_y = pickle.load( open( "/content/drive/My Drive/pap_smear/train_y.p", "rb" ) )
    valid_y = pickle.load( open( "/content/drive/My Drive/pap_smear/valid_y.p", "rb" ) )
    test_y = pickle.load( open( "/content/drive/My Drive/pap_smear/test_y.p", "rb" ) )
    test_dataset = Data.TensorDataset(train_x, train_y)
    test_dataset.dim=1
    test_dataset.target_dim=1
    ...
    torch.save(total_pred, 'PapsmearMaskTensor_UNet_Nuclei.pt')
