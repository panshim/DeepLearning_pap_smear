...
class HPADataset(Dataset):
    ...
    def __init__(self, data_path, phase='train', transform=False, max_mean="max", target_channels="3"):
        ...
        with h5py.File(self.data_path,"r") as h:
            ...
            self.data_names = list( h['media/shimin/LENOVO/GoogleDriveSync/hpa_train/train'].keys() )
    ...
    def __getitem__(self, idx):
        ...
        with h5py.File(self.data_path,"r") as h:
            ...
            data = h['media/shimin/LENOVO/GoogleDriveSync/hpa_train/train'][self.data_names[idx]][:]
